...
const elementWithexplanation = document.getElementById('explanatory-sentence')
console.log(elementWithexplanation)
elementWithexplanation.addEventListener('click',HidElement)

// change the number MinNumber and max number by button

const buttonSubmit = document.getElementById('button-submit')
buttonSubmit.addEventListener('click',ButtonNumberSubmit)


function ButtonNumberSubmit()
{
    let numberString = document.getElementById('big-number').value
    if (Number(numberString))
    {
        if (Number(numberString) > MinNumber)
        {
            MaxNumber = Number(numberString) 
    ...
    numberString = document.getElementById('small-number').value
        if (Number(numberString))
        {
            if (Number(numberString) > 0&&Number(numberString)<MaxNumber)
            {
                MinNumber = 0
            }
            else
            {
                MinNumber = Number(numberString) 
            }
        }       

}

function HidElement(event)
{
    elementWithexplanation.style.visibility = "hidden"; 
}
